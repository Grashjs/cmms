...
| HOLOSTAFF_TENANT_ID         | No       | Enables the optional [Holostaff](https://docs.holostaff.ai) in-app copilot together with `HOLOSTAFF_SOURCE_ID`. Both empty (the default) keep it fully off: no code loads, nothing is contacted. Never runs on the public request portal.                                                                             | (empty)               |
| HOLOSTAFF_SOURCE_ID         | No       | See `HOLOSTAFF_TENANT_ID`.                                                                                                                                                                                                                                                                                          | (empty)               |
