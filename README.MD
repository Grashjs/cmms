...
| JWT_SECRET_KEY              | No       | JWT secret key. Generate with `openssl rand -base64 32`                                                                                                                                                                                                                                                     | your_jwt_secret       |
...
- Open your configured `PUBLIC_FRONT_URL` in the browser to access Atlas CMMS.
