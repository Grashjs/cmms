const locale = {
  ...
  scheduled: 'Gepland',
  customize_shift: 'Dienst aanpassen',
  default_schedule: 'Standaardrooster',
  custom_capacity_by_week: 'Aangepaste capaciteit per week',
  total_weekly_capacity: 'Totale wekelijkse capaciteit {{hours}}h {{minutes}}m',
  hours_abbrev: 'u',
  minutes_abbrev: 'm',
  monday: 'Maandag',
  tuesday: 'Dinsdag',
  ...
  overdue: 'Over tijd',
  due_soon: 'Binnenkort verschuldigd',
