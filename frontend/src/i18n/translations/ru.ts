const ruJSON = {
  ...
  'free_cmms.title': 'Бесплатное программное обеспечение Atlas CMMS | Кредитная карта не требуется',
  ...
  'free_cmms.hero.title': 'Управляйте заказами на работу и активами - Бесплатно навсегда',
  ...
  'free_cmms.features.asset_tracking.title': 'Отслеживание жизненного цикла активов',
