const ruJSON = {
  ...
  auto_generate_asset_barcode: 'Автоматическая генерация штрихкодов',
  auto_generate_asset_barcode_description:
    'Если этот параметр включен, штрихкоды будут автоматически генерироваться при создании активов',
  ...
  rotate: 'Ротировать',
  rotate_api_key: 'Ротировать API ключ',
  rotate_api_key_confirm:
    'Это отозв текущий ключ и создаст новый. Старый ключ перестанет работать немедленно.',
  api_key_rotated_success: 'API ключ успешно ротирован',
  active: 'Активен',
  expired: 'Истёк',
  revoked: 'Отозван',
  ...
  reset: 'Сброс',
  confirm_delete_row: 'Вы уверены, что хотите удалить эту строку?',
  scheduled: 'Запланировано',
  customize_shift: 'Настроить смену',
  default_schedule: 'Расписание по умолчанию',
  custom_capacity_by_week: 'Индивидуальная емкость по неделям',
  total_weekly_capacity: 'Общая недельная емкость {{hours}}ч {{minutes}}м',
  hours_abbrev: 'ч',
  minutes_abbrev: 'м',
  monday: 'Понедельник',
  tuesday: 'Вторник',
  ...
  saturday: 'Суббота',
  sunday: 'Воскресенье',
  set_estimated_duration: 'Установить предполагаемую длительность',
  schedule: 'Расписание',
  workload_view: 'Просмотр загрузки',
  this_week: 'Эта неделя',
  total_resource_capacity: 'Общая емкость ресурсов',
  unscheduled_work_orders: 'Незапланированные заказы',
  user_capacity: 'Емкость пользователя',
  overdue: 'Просрочено',
  due_soon: 'Скоро срок',
  ...
  export_cost_and_time: 'Экспорт затрат и времени',
   ...
   copy_pm: 'Копировать профилактическое обслуживание',
   copy_pm_description:
     'Заполните поля ниже, чтобы скопировать профилактическое обслуживание',
   copy_asset: 'Копировать актив',
   copy_asset_description:
     'Заполните поля ниже, чтобы скопировать этот актив',
   copy_location: 'Копировать местоположение',
   copy_location_description:
     'Заполните поля ниже, чтобы скопировать это местоположение',
   copy_meter: 'Копировать счетчик',
  ...
  email_contractors: 'Отправить email подрядчикам',
