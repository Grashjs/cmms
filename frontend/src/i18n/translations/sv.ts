const locale = {
  ...
  customize_shift: 'Anpassa skift',
  default_schedule: 'Standardschema',
  custom_capacity_by_week: 'Anpassad kapacitet per vecka',
  total_weekly_capacity: 'Total veckokapacitet {{hours}}t {{minutes}}m',
  hours_abbrev: 't',
  minutes_abbrev: 'm',
  monday: 'Måndag',
  tuesday: 'Tisdag',
  ...
  saturday: 'Lördag',
  sunday: 'Söndag',
  set_estimated_duration: 'Ange beräknad varaktighet',
  schedule: 'Schema',
  workload_view: 'Arbetsbelastningsvy',
  this_week: 'Denna vecka',
  total_resource_capacity: 'Total resurskapacitet',
  unscheduled_work_orders: 'Oschemalagda arbetsorder',
  user_capacity: 'Användarkapacitet',
  overdue: 'Försenad',
  due_soon: 'Snart förfallen',
