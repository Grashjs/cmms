const locale = {
  ...
  rotate: 'Ruota',
  rotate_api_key: 'Ruota chiave API',
  rotate_api_key_confirm:
    'Questo revocerà la chiave attuale e ne genererà una nuova. La vecchia chiave smetterà di funzionare immediatamente.',
  api_key_rotated_success: 'Chiave API ruotata con successo',
  active: 'Attivo',
  expired: 'Scaduto',
  revoked: 'Revocato',
  ...
  customize_shift: 'Personalizza turno',
  default_schedule: 'Programma predefinito',
  custom_capacity_by_week: 'Capacità personalizzata per settimana',
  total_weekly_capacity: 'Capacità settimanale totale {{hours}}h {{minutes}}m',
  hours_abbrev: 'h',
  minutes_abbrev: 'm',
  monday: 'Lunedì',
  tuesday: 'Martedì',
  ...
  saturday: 'Sabato',
  sunday: 'Domenica',
  set_estimated_duration: 'Imposta durata stimata',
  schedule: 'Pianifica',
  workload_view: 'Vista carico di lavoro',
  this_week: 'Questa settimana',
  total_resource_capacity: 'Capacità totale risorse',
  unscheduled_work_orders: 'Ordini di lavoro non pianificati',
  user_capacity: 'Capacità utente',
  overdue: 'In ritardo',
