const locale = {
  ...
  'free_cmms.description': '免费 CMMS 软件 —— 并非试用版。立即管理维护、资产和工单。无需信用卡。',
  'free_cmms.keywords': '免费 cmms, 维护管理软件, 免费工单软件, 资产跟踪, 预防性维护',
  'overview.description': 'Atlas CMMS 是一款免费、开源的 CMMS，用于管理工单、预防性维护、资产和设施。立即优化您的维护业务。',
  'overview.keywords': 'CMMS, 计算机化维护管理系统, EAM, 企业资产管理, 开源 CMMS, 免费维护软件, 工单管理, 预防性维护, 资产跟踪, 设施管理, 维护跟踪软件, 设备维护, Atlas CMMS',
  'pricing.title': '价格 - Atlas CMMS',
  'pricing.description': 'Atlas CMMS 灵活的定价计划。在我们的开源 CMMS 的云端版本和自托管版本之间进行选择，以优化您的维护业务。',
  'free_cmms.hero.subtitle': '免费 CMMS 软件',
  'free_cmms.hero.title': '管理工单和资产 - 永久免费',
  'free_cmms.hero.description': '告别繁琐的电子表格和过时的工具。免费升级到现代化的 CMMS 软件。',
  ...
  'free_cmms.features.join_thousands': '加入成千上万使用全球最直观的免费 CMMS 的维护专业人士。',
  ...
  "portal_public_asset_warning": "此门户是公开的，不需要身份验证。列出的资产将对任何拥有链接的人可见。",
  "portal_public_location_warning": "此门户是公开的，不需要身份验证。列出的位置将对任何拥有链接的人可见。",
  "submit_request": "提交请求",
  "share_portal": "分享门户",
