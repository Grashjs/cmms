const esJSON = {
  ...
  home_description:
    'Cuando las pizarras y las notas adhesivas son un caos y necesita un CMMS que sea fácil de usar por su equipo, prueba {{shortBrandName}} ',
  ...
  'work-orders.description.short': 'Visualice y gestiona todas sus tareas',
  ...
  'part.descriptions.0':
    '¿No está seguro de qué repuestos tiene en stock o dónde se utilizan? ¿No sabes cuándo se acabarán sus repuestos o si sus técnicos tendrán los repuestos necesarios para hacer su trabajo?',
  'part.descriptions.1':
  ...
  'dashboard.title':
    'Sus datos a su manera, gracias a la implementación de tableros presonalizados',
  ...
  feedback_description: 'Danos su opinión',
  ...
  no_access_vendors_customers:
    'No tiene acceso a Proveedores y Contratistass. Comuníquese con su administrador si necesita tener acceso',
  ...
  simplify_wo_description:
    'Oculte controle de tiempo, costos y piezas en los detalles de la orden de trabajo mientras usa la aplicación móvil',
