const trJSON = {
  ...
  vendors_description: 'Tedarikçilerı seçin',
  ...
  customer_description_description:
    'Bu Müşterinin amacını birkaç satırla anlatın...',
  ...
  add_customer_description:
    'Yeni bir müşteri oluşturmak ve eklemek için aşağıdaki alanları doldurun',
  'noRows.customer.message': 'Müşteri dışarıdan çalışanlardır',
  'noRows.customer.action': "Müşteri oluşturmak için '' butonuna basın",
  type: 'Tip',
  ...
  add_vendor_description:
    'Yeni bir Tedarikçi oluşturmak ve eklemek için aşağıdaki alanları doldurun',
  confirm_delete_vendor: 'Bu Tedarikçiyi silmek istediğinizden emin misiniz?',
  'noRows.vendor.message': 'Tedarikçiler Varlık veya Parça sağlayan kuruluşlardır',
  'noRows.vendor.action': "Tedarikçi oluşturmak için '' düğmesine basın",
  ...
  'pricing.feature_unlimited_vendors': 'Sınırsız Tedarikçi',
