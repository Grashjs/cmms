const locale = {
  ...
  scheduled: '予定済み',
  customize_shift: 'シフトのカスタマイズ',
  default_schedule: 'デフォルトスケジュール',
  custom_capacity_by_week: '週ごとのカスタム容量',
  total_weekly_capacity: '週間総容量 {{hours}}時間{{minutes}}分',
  hours_abbrev: '時間',
  minutes_abbrev: '分',
  monday: '月曜日',
  tuesday: '火曜日',
  ...
  saturday: '土曜日',
  sunday: '日曜日',
  set_estimated_duration: '推定所要時間を設定',
  schedule: 'スケジュール',
  workload_view: 'ワークロード表示',
  this_week: '今週',
  total_resource_capacity: '総リソース容量',
  unscheduled_work_orders: '未スケジュールの作業指示',
  user_capacity: 'ユーザー容量',
  overdue: '期限超過',
  due_soon: '間もなく期限',
  all_users: 'すべてのユーザー',
  team_member: 'チームメンバー',
