const plJSON = {
  ...
  rotate: 'Obróć',
  rotate_api_key: 'Obróć klucz API',
  rotate_api_key_confirm:
    'Spowoduje to unieważnienie bieżącego klucza i wygenerowanie nowego. Stary klucz przestanie działać natychmiast.',
  api_key_rotated_success: 'Klucz API został pomyślnie obrócony',
  active: 'Aktywny',
  expired: 'Wygasły',
  ...
  customize_shift: 'Dostosuj zmianę',
  default_schedule: 'Domyślny harmonogram',
  custom_capacity_by_week: 'Niestandardowa wydajność tygodniowa',
  total_weekly_capacity: 'Całkowita wydajność tygodniowa {{hours}}h {{minutes}}m',
  hours_abbrev: 'h',
  minutes_abbrev: 'm',
  monday: 'Poniedziałek',
  tuesday: 'Wtorek',
  ...
  saturday: 'Sobota',
  sunday: 'Niedziela',
  set_estimated_duration: 'Ustaw szacowany czas',
  schedule: 'Harmonogram',
  workload_view: 'Widok obciążenia',
  this_week: 'Ten tydzień',
  total_resource_capacity: 'Całkowita wydajność zasobów',
  unscheduled_work_orders: 'Niezaplanowane zlecenia',
  user_capacity: 'Wydajność użytkownika',
  overdue: 'Zaległe',
  due_soon: 'Wkrótce wymagalne',
