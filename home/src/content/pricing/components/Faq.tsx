...
export default function Faq() {
  ...
  const faqItems: FaqItem[] = [
      ...
      content: (
        <>
          ...
          <Box component="ol" sx={{ pl: 2 }}>
            <li>
              <Typography variant="body1">
                <strong>{t('pricing_1.faq_admin_users_title')}</strong> — These
                users have the ability to
                {t('pricing_1.faq_admin_users_description')}
              </Typography>
            </li>
            <li>
              <Typography variant="body1">
            ...
            <li>
              <Typography variant="body1">
                <strong>
                  {t('pricing_1.faq_limited_technical_users_title')}
                </strong>{' '}
    ...
    },
    {
      ...
      content: (
        <Typography>{t('pricing_1.faq_non_profit_discounts_a')}</Typography>
      )
    },
    {
      id: 'panel7',
