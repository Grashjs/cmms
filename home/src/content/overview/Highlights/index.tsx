          ...
          <Grid justifyContent="center" alignItems="center" spacing={6} container>
            ...
            <Grid item xs={12} md={6}>
              <LayoutImgButton>
                ...
                <Image src="/static/images/overview/work_order_screenshot.png" alt={t("work_orders")} width={1920} height={922} sizes="(max-width: 900px) 100vw, 50vw" />
              </LayoutImgButton>
            </Grid>
            <Grid item xs={12} md={6}>
              <LayoutImgButton>
                <Typography variant="h4">{t("custom_dashboards")}</Typography>
                <Image src="/static/images/overview/analytics_screenshot.png" alt={t("custom_dashboards")} width={1920} height={922} sizes="(max-width: 900px) 100vw, 50vw" />
              </LayoutImgButton>
            </Grid>
            <Grid item xs={12} md={6}>
              <LayoutImgButton>
                <Typography variant="h4">{t("asset_management")}</Typography>
                <Image src="/static/images/overview/assets.png" alt={t("asset_management")} width={1920} height={869} sizes="(max-width: 900px) 100vw, 50vw" />
              </LayoutImgButton>
            </Grid>
          </Grid>
        </BoxLayoutsContent>
