const locale = {
  ...
  "home": {
    ...
    "what": "什么",
    "you_will_have": "您将拥有",
    "you_will_have_description": "构建高效、可靠的工作流程，让您掌控维护工作。生成、分配和跟踪工单。控制库存。获得可靠的自动化报告，提高可见性并创建问责制。",
    "smarter": "更智能",
    "work": "工作",
    "smarter_description": "{shortBrandName}通过为技术人员提供完成工作所需的工具和数据访问权限，使他们能够高效工作变得异常简单 — 所有这些都来自他们的手掌。",
    "h1": "您可以自托管或在云端使用的免费开源 CMMS",
    "h2": "功能强大且成本低廉的维护",
    "h3": "停止依赖电子表格和白板。{brandName} 帮助维护团队计划干预、跟踪设备并保持合规。在您的服务器上自托管或立即在云端开始。"
  },
  "home_description": "当白板和便利贴变成混乱，而您需要一个足够简单让团队真正使用的CMMS软件时 - 试试{shortBrandName}",
  "try_grash": "试用{shortBrandName}",
  "login": "登录",
  "start_trial": "开始免费试用",
  "key_features": "主要功能",
  "key_features_description": "一些使{shortBrandName}成为当今最佳CMMS之一的功能",
  "contribute": "贡献",
  "work_orders": "工单",
  ...
  "save": "保存",
  "customers": "承包商",
  "no_labor": "尚未添加劳动成本。当用户记录时间并在{brandName}中保存小时费率时，它们将出现在这里。",
  "not_assigned": "未分配",
  ...
  "noRows": {
    "wo": {
      "message": "工单是可以安排或分配给某人的任务或作业",
      "action": "按'+'按钮创建工单"
    },
    "pm": {
      "message": "预防性维护是帮助维护资产的重复任务",
      "action": "按'+'按钮创建预防性维护"
    },
    "location": {
      "message": "位置让您更有效地管理资产和工人",
      "action": "按'+'按钮创建位置"
    },
    "part": {
      "message": "零件可以组合成资产或单独使用",
      "action": "按'+'按钮创建零件"
    },
    "po": {
      "message": "在一个地方管理您的采购订单",
      "action": "按'+'按钮创建采购订单。"
    },
    "meter": {
      "message": "仪表读数让您能够监控资产并根据定义的条件触发新工单",
      "action": "按'+'按钮创建仪表"
    },
    "customer": {
      "message": "承包商是外部工人",
    ...
    "vendor": {
      "message": "供应商是提供资产或零件的组织",
      "action": "按'+'按钮创建供应商"
    },
    "team": {
      "message": "团队帮助您管理特定的人群。",
      "action": "按'+'按钮创建团队。"
    },
    "file": {
      "message": "在一个地方获取所有文件",
    ...
    "checklist": {
      "message": "检查清单帮助您标准化工作",
      "action": "按'+'按钮创建检查清单"
    },
    "asset": {
      "message": "资产是您的公司可以干预的资源",
      "action": "按'+'按钮创建新资产。"
    }
  },
  "to_delete": "删除",
  ...
  "no_access_vendors_customers": "您无权访问供应商和承包商。如果您应该有访问权限，请联系您的管理员",
  "no_access_people_team": "您无权访问人员和团队。如果您应该有访问权限，请联系您的管理员",
  "no_access_analytics": "您无权访问分析。如果您应该有访问权限，请联系您的管理员",
  "no_access_assets": "您无权访问资产。如果您应该有访问权限，请联系您的管理员",
  "no_access_categories": "您无权访问类别。如果您应该有访问权限，请联系您的管理员",
  ...
  "no_access_purchase_orders": "您无法创建采购订单。如果您应该有访问权限，请联系您的管理员",
  ...
  "add_20_users": "您可以通过在每次电子邮件输入后按'tab'或'enter'一次添加20个用户。任何重复和已注册的电子邮件地址将在请求用户注册时被删除。",
  ...
  "LIMITED_ADMIN_description": "有限管理员与管理员具有相同的访问权限，除了他们无法查看/编辑设置或添加/编辑人员和团队。他们无法删除工单、资产、位置、仪表和采购订单，除非他们创建了承包商、类别和PM触发器。",
  "TECHNICIAN_name": "技术员",
  "TECHNICIAN_description": "技术员可以创建和关闭工单、资产和位置。只能编辑和删除他们创建的内容",
  ...
  "external_id": "外部ID",
  "permissions": "权限",
  "create_role_description": "此角色可以执行管理员在{brandName}中可以执行的所有操作，但您可以在下面自定义一些重要权限。",
  ...
  "my_account": "我的账户",
  "my_company": "我的公司",
  "you_are_using_plan": "您当前使用的是{planName}计划。它将在{expiration}到期。立即升级以获得更多功能。",
  "upgrade_plan": "升级计划",
  "plans": "计划",
  "monthly": "月度",
  "annually": "年度",
  ...
  "pay_only_for_roles": "仅为<strong>管理员</strong>、<strong>技术</strong>和<strong>有限技术</strong>用户付费，免费使用无限<strong>请求者</strong>、<strong>仅查看</strong>",
  "checkout_our": "查看我们的",
  "pricing_page": "定价页面",
  ...
  "and_optional": "和（可选）",
  "then": "那么",
  "workflow_description": "创建自定义工作流就像如果、和、那么一样简单。节省时间并通过工作流自动分配您的工单，以自定义{shortBrandName}适应您团队的工作方式。\n所有计划都可以创建最多1个自定义工作流。要添加其他工作流，请升级到我们的商业计划",
  ...
  "verify_email_description": "验证电子邮件已发送给您。如果在收件箱中看不到，请检查垃圾邮件。",
  "upgrade": "升级",
  "downgrade": "降级",
  "upgrade_description": "您刚刚升级了订阅计划。您需要启用可能使用{shortBrandName}的禁用用户。您只能为当前订阅执行一次此操作。请仔细选择",
  "enable_users": "启用用户",
  "max_users_description": "您最多可以启用{maxUsers}个用户",
  "downgrade_description": "您刚刚降级了订阅计划。您需要禁用一些用户才能继续。您只能为当前订阅执行一次此操作。请仔细选择",
  "disable_users": "禁用用户",
  "min_users_description": "您必须至少禁用{minUsers}个用户",
  "downgrade_description_no_owner": "您的公司刚刚降级了订阅计划。公司所有者需要在您继续之前禁用一些用户",
  "past_due": "逾期",
  ...
  "main": {
    "title": "免费开源 CMMS（维护管理软件）– "
  },
  "talk_to_sales": "与销售联系",
  "pricing_1": {
    "choose_plan_and_get_started": "选择您的套餐并开始使用",
    "slogan_effective_maintenance": "我们的软件为维护和可靠性团队提供了高效运行运营所需的工具。",
    "compare_plans_and_pricing": "比较方案和价格",
    "see_which_plan_is_right_for_you": "看看哪个方案最适合你",
    "select_two_plans_to_compare": "选择 2 个方案进行比较",
    "select_three_plans_to_compare": "选择 3 个方案进行比较",
    "month_per_user": "每用户每月",
    "year_per_user": "每用户每年",
    "plan_basic_name": "基本的",
    "plan_basic_description": "团队希望跟踪资产并制定基本的预防性维护计划和程序。",
    "feature_unlimited_work_orders": "无限量工作订单",
    "feature_custom_tasks": "自定义任务",
    "feature_unlimited_request_user_licenses": "无限制用户许可申请",
    "plan_starter_name": "起动机",
    "plan_starter_description": "团队希望通过机器状态和人力资源可视化来构建高效、强大的预防性维护体系。",
    "feature_everything_in_basic_plus": "Basic Plus 包含以下所有内容：",
    "feature_preventive_maintenance_recurring_work_orders": "预防性维护/定期工作单",
    "feature_custom_checklists": "自定义清单",
    "feature_inventory_management_costing": "库存管理/成本核算",
    "feature_time_and_manpower_tracking": "时间和人力跟踪",
    "feature_thirty_day_analytics_reporting": "30 天分析与报告",
    "plan_professional_name": "专业的",
    "plan_professional_description": "需要利用洞察力和分析来推动维护业务进一步增长和提高生产力的部门。",
    "feature_everything_in_starter_plus": "Starter Plus 版包含的所有内容：",
    "feature_multiple_inventory_lines": "多条库存线",
    "feature_customizable_request_portal": "可定制请求门户",
    "feature_mobile_offline_mode": "移动离线模式",
    "feature_advanced_analytics_reporting": "高级分析与报告",
    "plan_business_name": "商业",
    "plan_business_description": "准备收集维护和运营数据以管理多个地点和系统定制的组织。",
    "feature_everything_in_professional_plus": "专业版及以上所有功能：",
    "feature_purchase_order_management": "采购订单管理",
    "feature_multi_site_module_support": "多站点模块支持",
    "feature_custom_work_order_statuses": "定制工单状态",
    "feature_custom_integrations_support": "自定义集成支持",
    "feature_work_order_management": "工单管理",
    "feature_recurring_work_orders": "重复性工作订单",
    "feature_custom_categories": "自定义类别",
    "feature_data_importing": "数据导入",
    "feature_time_and_cost_tracking": "时间和成本跟踪",
    "feature_work_order_configuration": "工单配置",
    "feature_internal_requests": "内部请求",
    "feature_external_request_portal": "外部请求门户",
    "category_locations_assets_parts": "地点、资产和部件",
    "feature_location_management": "位置管理",
    "feature_barcode_scanning": "条形码扫描",
    "feature_inventory_management": "库存管理",
    "feature_custom_asset_statuses": "自定义资产状态",
    "feature_asset_downtime_tracking": "资产停机时间跟踪",
    "feature_asset_depreciation_tracking": "资产折旧跟踪",
    "feature_asset_warranty_tracking": "资产保修跟踪",
    "feature_purchase_orders_management": "采购订单",
    "feature_asset_check_in_out": "资产登记入库/出库",
    "category_mobile_offline": "移动离线",
    "feature_work_order_availability": "工作订单可用性",
    "feature_updating_status": "正在更新状态",
    "feature_updating_tasks": "更新任务",
    "feature_work_order_drafts": "工作单草稿",
    "feature_full_drill_down_reporting_history": "完整的钻取式报告和历史记录",
    "period_thirty_days": "30天",
    "period_full": "满的",
    "feature_pdf_csv_exporting": "PDF 和 CSV 导出",
    "feature_itemized_time_reporting": "逐项工时报告",
    "feature_user_login_reports": "用户登录报告",
    "feature_parts_consumption_reports": "零部件消耗报告",
    "feature_asset_downtime_reports": "资产停机报告",
    "feature_equipment_reliability_reports": "设备可靠性报告",
    "feature_multi_site_modules": "多站点模块",
    "category_integrations": "集成",
    "feature_business_integrations": "业务集成（SAP/Oracle/Causal AI...）",
    "feature_custom_integrations": "自定义集成",
    "feature_unlimited_view_only_users": "无限制的只读用户",
    "feature_unlimited_requesters": "无限请求者",
    "feature_unlimited_vendors": "无限供应商",
    "feature_unlimited_customers": "无限客户",
    "category_support": "支持",
    "feature_daily_email_digest": "每日邮件摘要",
    "feature_articles": "文章",
    "feature_training_webinars": "培训网络研讨会",
    "feature_community_support_discord": "社区支持（Discord）",
    "feature_email_support": "电子邮件支持",
    "feature_chat_phone_support": "在线聊天/电话支持",
    "feature_priority_support": "优先支持",
    "feature_implementation_training": "实施与培训",
    "feature_dedicated_account_manager": "专属客户经理",
    "category_customization": "定制",
    "feature_custom_development": "定制开发",
    "sh_plan_basic_name": "基本的",
    "sh_plan_basic_description": "适用于需要对其自身基础设施拥有完全数据主权和基本维护跟踪的小型团队。",
    "sh_feature_core_work_order_management": "核心工单管理",
    "sh_feature_asset_inventory_tracking": "资产与库存跟踪",
    "sh_feature_local_data_storage": "本地数据存储",
    "sh_plan_professional_name": "专业的",
    "sh_plan_professional_description": "非常适合种植需要高级检查清单、工作流程和更深入的系统集成的植物。",
    "sh_feature_everything_in_basic_plus": "Basic Plus 包含以下所有内容：",
    "sh_feature_unlimited_assets_checklists": "无限资产/清单",
    "sh_feature_nfc_barcode_scanning": "NFC和条形码扫描",
    "sh_feature_email_support": "电子邮件支持",
    "sh_plan_business_name": "商业",
    "sh_plan_business_description": "需要多实例管理、定制品牌和顶级安全性的全面运营。",
    "sh_feature_everything_in_professional_plus": "专业版及以上所有功能：",
    "sh_feature_multi_instance_management": "多实例管理",
    "sh_feature_custom_user_roles": "自定义用户角色",
    "sh_feature_priority_implementation_support": "优先实施支持",
    "faq_free_users_q": "哪些类型的用户属于免费用户？",
    "faq_free_users_a1": "有三种用户类型不需要付费许可证：",
    "faq_view_only_users_title": "仅查看用户",
    "faq_view_only_users_description": "这些用户通常是主管，他们不经常登录查看维护活动的概览。他们还可以提交工作请求和生成报告。",
    "faq_requester_users_title": "请求用户",
    "faq_requester_users_description": "这些用户只能提交工作请求并查看请求状态。他们无法查看工单、资产、零件或存储在 CMMS 中的任何其他数据。",
    "faq_third_party_users_title": "第三方用户",
    "faq_third_party_users_description": "这些用户通常是供应商和承包商。他们实际上无法登录系统。他们只能通过公开链接提交与其关联的特定工单的更新信息。",
    "faq_paid_users_q": "哪些类型的用户属于付费用户？",
    "faq_paid_users_a1": "有三种用户类型需要付费许可证：",
    "faq_admin_users_title": "管理员用户",
    "faq_admin_users_description": "这些用户可以向账户添加其他成员、接受或拒绝工作请求以及编辑工单详情。他们是账户的控制用户。每个账户可以设置多个管理员。",
    "faq_technical_users_title": "技术用户",
    "faq_technical_users_description": "这些用户通常是现场负责完成工单的技术人员。他们可以编辑自己创建的工单，但不能编辑其他工单。他们可以向工单添加图片和状态更新，也可以创建新的工单。",
    "faq_limited_technical_users_title": "有限技术用户",
    "faq_limited_technical_users_description": "这些用户拥有与技术用户相同的权限。唯一的区别是，他们只能看到分配给他们的工单，而看不到账户上其他技术用户的工作订单。",
    "faq_change_plans_q": "我之后可以更改计划吗？",
    "faq_change_plans_a": "是的，您可以随时升级或降级您的套餐。更改将在您的下一个账单周期开始时生效。",
    "faq_free_trial_q": "有免费试用吗？",
    "faq_free_trial_a": "是的，我们提供 15 天的商务计划免费试用期，以便您在做决定前体验所有功能。",
    "faq_non_profit_discounts_q": "你们为非营利组织提供折扣吗？",
    "faq_non_profit_discounts_a": "是的，我们为非营利组织提供特价优惠。请联系我们的销售团队了解更多信息。",
    "faq_payment_methods_q": "你们接受哪些付款方式？",
    "faq_payment_methods_a": "我们接受所有主流信用卡、银行转账和PayPal付款。对于企业套餐，我们还可以安排开具发票。",
    "faq_cancel_subscription_q": "我可以取消订阅吗？",
    "faq_cancel_subscription_a": "是的，您可以随时取消订阅。取消后，您仍可继续使用服务直至当前账单周期结束。",
    "faq_data_secure_q": "我的数据安全吗？",
    "faq_data_secure_a": "是的，我们非常重视数据安全。所有数据在传输和存储过程中均进行加密，并且我们会定期进行安全审计。",
    "faq_title": "常见问题解答",
