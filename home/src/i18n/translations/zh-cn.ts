const locale = {
  ...
  free_cmms: {
    ...
    hero: {
      subtitle: "免费 CMMS 软件",
      title: "管理工单和资产 - 永久免费",
      description: "告别繁琐的电子表格和过时的工具。免费升级到现代化的 CMMS 软件。",
      start_free: "立即免费开始",
      work_orders_alt: "工单",
      mobile_app_alt: "移动应用",
    },
    features: {
      ...
      mobile: {
        title: "随时随地进行维护",
        p1: "适用于 iOS 和 Android 的完整移动应用功能。",
        p2: "直接在现场拍照并扫描条形码。",
        p3: "即时同步数据，并根据需要离线工作。",
        alt: "移动 CMMS 应用",
      },
      get_started_free: "免费开始",
      ready_to_optimize: "准备好优化您的维护了吗？",
      join_thousands: "加入成千上万使用全球最直观的免费 CMMS 的维护专业人士。",
      get_started_no_card: "免费开始 - 无需信用卡",
    },
  },
  overview_1: {
