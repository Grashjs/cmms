const locale = {
  ...
  free_cmms: {
    title: "Atlas Free CMMS Software | No credit card required",
    description:
    ...
    hero: {
      subtitle: "Free CMMS Software",
      title: "Manage Work Orders and Assets - Free Forever",
      description: "Stop juggling spreadsheets and outdated tools. Upgrade to a modern CMMS software - for free.",
      start_free: "Start Free Now",
      work_orders_alt: "Work Orders",
      mobile_app_alt: "Mobile App",
    },
    features: {
      work_orders: {
        title: "Effortless Work Orders",
        p1: "Create, assign, and track work orders in seconds.",
        p2: "Attach photos, manuals, and checklists to any task.",
        p3: "Monitor progress in real-time with instant status updates.",
        alt: "Work Order Management",
      },
      asset_tracking: {
        title: "Asset Lifecycle Tracking",
        p1: "Maintain a complete digital history of every asset.",
        p2: "Make data-driven decisions on repair vs. replace.",
        p3: "Stay audit-ready with automated compliance logs.",
        alt: "Asset Management",
      },
      inventory: {
        title: "Inventory & Parts",
        p1: "Track stock levels across multiple locations in real-time.",
        p2: "Scan QR codes for instant part lookup and usage.",
        p3: "Get automated low-stock alerts and reorder instantly.",
        alt: "Inventory Management",
      },
      mobile: {
        title: "Maintenance on the Go",
        p1: "Full mobile app functionality for iOS and Android.",
        p2: "Capture photos and scan barcodes directly from the field.",
        p3: "Sync data instantly and work offline when needed.",
        alt: "Mobile CMMS App",
      },
      get_started_free: "Get started for free",
      ready_to_optimize: "Ready to optimize your maintenance?",
      join_thousands: "Join thousands of maintenance professionals using the world's most intuitive free CMMS.",
      get_started_no_card: "Get started for free - No credit card required",
    },
  },
  overview_1: {
    description:
