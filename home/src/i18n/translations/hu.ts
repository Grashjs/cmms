const locale = {
  ...
  free_cmms: {
    ...
    hero: {
      subtitle: "Ingyenes GMAO Szoftver",
      title: "Munkarendelések és eszközök kezelése - Örökké ingyenes",
      description:
        "Hagyja abba a táblázatokkal és elavult eszközökkel való zsonglőrködést. Váltson egy modern GMAO szoftverre - ingyen.",
      start_free: "Kezdje el ingyen most",
      work_orders_alt: "Munkarendelések",
      mobile_app_alt: "Mobilalkalmazás",
    },
    features: {
      work_orders: {
        title: "Munkarendelések könnyedén",
        p1: "Munkarendelések létrehozása, kiosztása és nyomon követése másodpercek alatt.",
        p2: "Fotók, kézikönyvek és ellenőrzőlisták csatolása bármilyen feladathoz.",
        p3: "A folyamatok valós idejű nyomon követése azonnali állapotfrissítésekkel.",
        alt: "Munkarendelés-kezelés",
      },
      asset_tracking: {
        title: "Eszköz életciklus követése",
        p1: "Vezessen teljes digitális előzményt minden eszközről.",
        p2: "Hozzon adatvezérelt döntéseket a javítás vagy csere kérdésében.",
        p3: "Maradjon audit-kész az automatizált megfelelőségi naplókkal.",
        alt: "Eszközkezelés",
      },
      inventory: {
        title: "Készlet és alkatrészek",
        p1: "A készletszintek valós idejű nyomon követése több helyszínen.",
        p2: "QR-kódok beolvasása az azonnali alkatrész-kereséshez és felhasználáshoz.",
        p3: "Automatikus értesítések alacsony készletszint esetén és azonnali utánrendelés.",
        alt: "Készletkezelés",
      },
      mobile: {
        title: "Karbantartás útközben",
        p1: "Teljes mobilalkalmazás-funkcionalitás iOS és Android rendszerekre.",
        p2: "Fotók készítése és vonalkódok beolvasása közvetlenül a terepen.",
        p3: "Azonnali adatszinkronizálás és offline munkavégzés, ha szükséges.",
        alt: "Mobil GMAO alkalmazás",
      },
      get_started_free: "Kezdés ingyenesen",
      ready_to_optimize: "Készen áll a karbantartás optimalizálására?",
      join_thousands:
        "Csatlakozzon a világ legintuitívabb ingyenes GMAO-ját használó karbantartási szakemberek ezreihez.",
      get_started_no_card: "Kezdés ingyenesen - Nincs szükség hitelkártyára",
    },
  },
  overview_1: {
    description:
