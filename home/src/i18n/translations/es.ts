const esJSON = {
  ...
  home: {
    ...
    h1: "GMAO gratuito y de código abierto que puede alojar usted mismo o usar en la nube",
  ...
  main: {
    title: "GMAO gratuito de código abierto (software de gestión de mantenimiento)",
  },
  ...
  pricing_1: {
    ...
    faq_change_plans_a:
      "Sí, puedes cambiar a un plan superior o inferior en cualquier momento. Los cambios entran en vigor al inicio de tu próximo ciclo de facturación.",
    ...
    faq_cancel_subscription_a:
      "Sí, puedes cancelar tu suscripción en cualquier momento. Seguirás teniendo acceso hasta el final de tu periodo de facturación actual.",
  ...
  free_cmms: {
    ...
    hero: {
      subtitle: "Software GMAO Gratuito",
      title: "Gestione Órdenes de Trabajo y Activos - Gratis para siempre",
      description:
        "Deje de hacer malabares con hojas de cálculo y herramientas obsoletas. Actualice a un moderno software GMAO - gratis.",
      start_free: "Comience Gratis Ahora",
      work_orders_alt: "Órdenes de Trabajo",
      mobile_app_alt: "Aplicación Móvil",
    },
    features: {
      work_orders: {
        title: "Órdenes de Trabajo sin Esfuerzo",
        p1: "Cree, asigne y realice un seguimiento de las órdenes de trabajo en segundos.",
        p2: "Adjunte fotos, manuales y listas de verificación a cualquier tarea.",
        p3: "Supervise el progreso en tiempo real con actualizaciones de estado instantáneas.",
        alt: "Gestión de Órdenes de Trabajo",
      },
      asset_tracking: {
        title: "Seguimiento del Ciclo de Vida de los Activos",
        p1: "Mantenga un historial digital completo de cada activo.",
        p2: "Tome decisiones basadas en datos sobre reparar o reemplazar.",
        p3: "Manténgase listo para auditorías con registros de cumplimiento automatizados.",
        alt: "Gestión de Activos",
      },
      inventory: {
        title: "Inventario y Piezas",
        p1: "Rastree los niveles de stock en múltiples ubicaciones en tiempo real.",
        p2: "Escanee códigos QR para buscar y usar piezas instantáneamente.",
        p3: "Reciba alertas automáticas de bajo stock y reordene al instante.",
        alt: "Gestión de Inventario",
      },
      mobile: {
        title: "Mantenimiento en Movimiento",
        p1: "Funcionalidad completa de la aplicación móvil para iOS y Android.",
        p2: "Capture fotos y escanee códigos de barras directamente en el campo.",
        p3: "Sincronice datos al instante y trabaje sin conexión cuando sea necesario.",
        alt: "Aplicación GMAO Móvil",
      },
      get_started_free: "Comience gratis",
      ready_to_optimize: "¿Listo para optimizar su mantenimiento?",
      join_thousands:
        "Únase a miles de profesionales del mantenimiento que utilizan el GMAO gratuito más intuitivo del mundo.",
      get_started_no_card: "Comience gratis - No se requiere tarjeta de crédito",
    },
  },
  overview_1: {
    description:
