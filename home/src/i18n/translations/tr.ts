const trJSON = {
  ...
  "home": {
    "built": "Bakım Yönetimini Kolaylaştırmak için Tasarlandı",
    "what": "Ne",
    "you_will_have": "Sahip olacaksın",
    "you_will_have_description": "Bakımın kontrolünü size veren verimli, güvenilir iş akışları oluşturun. ",
    "smarter": "Daha akıllı",
    "work": "İş",
    "smarter_description": "{shortBrandName}, teknisyenlerin işlerini yapmak için ihtiyaç duydukları araçlara ve verilere avuçlarının içinden erişmelerini sağlayarak verimli çalışmalarını inanılmaz derecede kolaylaştırıyor.",
    "h1": "Kendi sunucunuzda barındırabileceğiniz veya bulutta kullanabileceğiniz ücretsiz ve açık kaynaklı CMMS",
    "h2": "Düşük Maliyetle Güçlü Bakım",
    "h3": "Elektronik tablolara ve beyaz tahtalara güvenmeyi bırakın. {brandName}, bakım ekiplerinin müdahaleleri planlamasına, ekipmanları takip etmesine ve uyumlu kalmasına yardımcı olur. Kendi sunucunuzda barındırın veya bulutta anında başlayın."
  },
  "home_description": "Beyaz tahtalar ve yapışkan notlar kaosa dönüştüğünde ve ekibinizin gerçekten kullanabileceği kadar kolay bir CMMS yazılımına ihtiyaç duyduğunuzda {shortBrandName}'ı deneyin",
  "try_grash": "{shortBrandName}'ı deneyin",
  "login": "Giriş",
  "start_trial": "Ücretsiz denemeyi başlatın",
  "key_features": "Ana Özellikler",
  "key_features_description": "{shortBrandName}'ı günümüzün en iyi CMMS'lerinden biri yapan özelliklerden bazıları",
  ...
  "work-orders": {
    "title": "İş Emirlerinizi bir Patron gibi yönetin",
    "description": {
      "short": "Tüm Görevlerinizi Görüntüleyin ve Yönetin"
    },
    "descriptions": [
  ...
  "work-requests": {
    "title": "Kolaylaştırılmış bir mobil iş talebi sistemi",
    "descriptions": [
    ...
    "checks": [
      "İş'i bir daha asla kaybetmeyin.",
  ...
  "mobile-app": {
    "title": "Bakım ekibinize güç veren mobil CMMS uygulaması",
    "descriptions": [
    ...
    "checks": [
      "Atanan İş Emirlerini ve PM'lerini görüntüleyin.",
      "İş Emirlerini 60 saniyeden kısa sürede kaydedin",
      "Push ve e-posta bildirimleri aracılığıyla anında iletişim alın.",
      "Sahadayken yeni İş Emirleri başlatın.",
  ...
  "eam": {
    "title": "Kurumsal Varlık Yönetimi",
    "description": {
      "short": "Varlıklarınızı bilin"
    },
    "descriptions": [
    ...
    "checks": [
      ...
      "Tam ve ayrıntılı Bakım Günlüklerini görüntüleyin.",
      "Sınırsız özel alanlarla yalnızca istediğinizi takip edin",
      ...
      "Sensör bağlantısıyla gerçek zamanlı varlık verilerini alın."
    ]
  },
  "pm": {
    "title": "Etkili Bir Önleyici Bakım Programı",
    "descriptions": [
    ...
    "checks": [
      ...
      "Son tarihi değiştirmek için sürükleyip bırakın.",
      "PM tamamlandıktan sonra iş otomatik olarak varlığın bakım günlüğüne kaydedilir.",
      "Kullanımı çok az eğitim gerektirir veya hiç gerektirmez."
    ]
  },
  "part_1": {
    "title": "Yedek Parça Envanterinizin Kontrolünü Elinize Alın",
    "description": {
      "short": "Parçalarınızın ne zaman tükeneceğini bilin"
    },
    "descriptions": [
    ...
    "checks": [
      ...
      "Otomatik parça kullanım takibi. ",
      "Parça kullanımını bilin. ",
      "Kullanılmayan parçaları ortadan kaldırın. ",
  ...
  "dashboard": {
    "title": "Özel kontrol panelleriyle verileriniz sizin tarzınızda",
    "descriptions": [
    ...
    "checks": [
      "Paranızın nereye ve neden harcandığını bilin",
      "Hangi varlığın en çok maliyetli olduğunu ve nedenini öğrenin",
      "Kendi özel KPI'larınızı oluşturun.",
  ...
  "wo": {
    "title_description": "İş Emri başlığını girin"
  },
  "image": "Resim",
  ...
  "noRows": {
    "wo": {
      "message": "İş Emirleri, birisine planlanabilen veya atanabilen görevler veya işlerdir.",
      "action": "İş Emri oluşturmak için '' butonuna basın"
    },
    "pm": {
      "message": "Özel tetikleyicilerle İş Emirlerini planlayın",
      "action": "Tetikleyici oluşturmak için '' düğmesine basın"
    },
    "request": {
      "message": "İş taleplerinizi Yönetin",
      "action": "İş talebi oluşturmak için '' butonuna basın"
    },
    "location": {
      "message": "Konumlar, varlıkları ve çalışanları daha verimli bir şekilde yönetmenize olanak tanır",
      "action": "Konum oluşturmak için '' düğmesine basın"
    },
    "part": {
      "message": "Parçalar varlıklar halinde birleştirilebilir veya tek başına kullanılabilir",
      "action": "Parça oluşturmak için '' düğmesine basın"
    },
    "po": {
      "message": "Satınalma Siparişlerinizi tek yerden yönetin",
      "action": "Satınalma Siparişi oluşturmak için '' butonuna basın."
    },
    "meter": {
      "message": "Ölçer okumaları size varlıkları izleme ve tanımlanmış koşullara göre yeni iş emirlerini tetikleme olanağı sağlar",
      "action": "Bir Ölçer oluşturmak için '' düğmesine basın"
    },
    "customer": {
      "message": "Yükleniciler dışarıdan çalışanlardır",
      "action": "Yüklenici oluşturmak için '' butonuna basın"
    },
    "vendor": {
      "message": "Satıcılar Varlık veya Parça sağlayan kuruluşlardır",
      "action": "Satıcı oluşturmak için '' düğmesine basın"
    },
    "team": {
    ...
    "file": {
      "message": "Tüm dosyaları Tek bir yerde toplayın",
      "action": "Dosya yüklemek için '' butonuna basın"
    },
    "asset": {
      "message": "Varlıklar şirketinizin müdahale edebileceği kaynaklardır",
      "action": "Yeni bir Varlık oluşturmak için '' düğmesine basın."
    }
  },
  "to_delete": "Sil",
  ...
  "permissions": "İzinler",
  "create_role_description": "Bu rol, bir Yöneticinin {brandName}'ta yapabileceği her şeyi yapabilir ancak bazı önemli izinleri aşağıda özelleştirebilirsiniz.",
  ...
  "number_users_who_will_use_grash": "{shortBrandName}'ı kullanacak kullanıcı sayısı",
  "admin_role": "Yönetici",
  ...
  "password_leave_empty_if_you_dont_want_to_change": "Şifre - değiştirmek istemiyorsanız boş bırakın",
  "upgrade_request_success": "Yükseltme talebiniz alındı! Ödeme detaylarıyla yakında sizinle iletişime geçeceğiz",
  ...
  "schedule": {
    "daily_one": "Her {count} gün",
    "daily_other": "Her {count} gün",
    "weekly_one": "Her {count} hafta {days} üzerinde",
    "weekly_other": "Her {count} hafta {days} üzerinde",
    "monthly_one": "Her {count} ay",
    "monthly_other": "Her {count} ay",
    "yearly_one": "Her {count} yıl",
    "yearly_other": "Her {count} yıl"
  },
  "csv_separator": "CSV ayırıcı",
  "open_source_cmms": "Açık kaynaklı CMMS",
  "main": {
    "title": "Ücretsiz açık kaynaklı CMMS (bakım yönetimi yazılımı) – "
  },
  "talk_to_sales": "Satışla konuşun",
  "pricing_1": {
    "choose_plan_and_get_started": "Planınızı seçin ve başlayın.",
    "slogan_effective_maintenance": "Yazılımımız, Bakım ve Güvenilirlik ekiplerine operasyonları verimli ve etkili bir şekilde yürütmek için ihtiyaç duydukları araçları sağlar.",
    "compare_plans_and_pricing": "Planları ve Fiyatları Karşılaştırın",
    "see_which_plan_is_right_for_you": "Hangi planın size uygun olduğunu görün.",
    "select_two_plans_to_compare": "Karşılaştırmak için 2 plan seçin.",
    "select_three_plans_to_compare": "Karşılaştırmak için 3 plan seçin.",
    "month_per_user": "kullanıcı başına aylık",
    "year_per_user": "kullanıcı başına yıl",
    "plan_basic_name": "Temel",
    "plan_basic_description": "Ekipler, varlıkları takip etmek ve prosedürlerle temel önleyici bakım programları oluşturmak istiyor.",
    "feature_unlimited_work_orders": "Sınırsız iş emri",
    "feature_custom_tasks": "Özel görevler",
    "feature_unlimited_request_user_licenses": "Sınırsız Kullanıcı Lisansı Talebi",
    "plan_starter_name": "Başlangıç",
    "plan_starter_description": "Ekipler, makine durumu ve iş gücü görünürlüğü yoluyla verimli ve güçlü önleyici bakım sistemleri kurmayı hedefliyor.",
    "feature_everything_in_basic_plus": "Temel paketin tüm özelliklerine ek olarak:",
    "feature_preventive_maintenance_recurring_work_orders": "Önleyici Bakım/Tekrarlayan İş Emirleri",
    "feature_custom_checklists": "Özel Kontrol Listeleri",
    "feature_inventory_management_costing": "Envanter yönetimi/Maliyetlendirme",
    "feature_time_and_manpower_tracking": "Zaman ve İşgücü Takibi",
    "feature_thirty_day_analytics_reporting": "30 Günlük Analiz ve Raporlama",
    "plan_professional_name": "Profesyonel",
    "plan_professional_description": "Bakım süreçlerinde büyüme ve verimliliği artırmak için içgörülerden ve analitik verilerden yararlanması gereken departmanlar.",
    "feature_everything_in_starter_plus": "Başlangıç paketindeki her şeye ek olarak:",
    "feature_multiple_inventory_lines": "Çoklu Envanter Kalemleri",
    "feature_customizable_request_portal": "Özelleştirilebilir Talep Portalı",
    "feature_mobile_offline_mode": "Mobil Çevrimdışı Modu",
    "feature_advanced_analytics_reporting": "Gelişmiş Analitik ve Raporlama",
    "plan_business_name": "İşletme",
    "plan_business_description": "Organizasyonlar, birden fazla lokasyonu yönetmek ve sistem özelleştirmesi yapmak için bakım ve operasyon verilerini toplamaya hazır.",
    "feature_everything_in_professional_plus": "Professional Plus paketindeki her şey:",
    "feature_purchase_order_management": "Satın Alma Siparişi Yönetimi",
    "feature_multi_site_module_support": "Çoklu Site Modülü Desteği",
    "feature_custom_work_order_statuses": "Özel İş Emri Durumları",
    "feature_custom_integrations_support": "Özel Entegrasyon Desteği",
    "feature_work_order_management": "İş Emri Yönetimi",
    "feature_recurring_work_orders": "Tekrarlayan İş Emirleri",
    "feature_custom_categories": "Özel Kategoriler",
    "feature_data_importing": "Veri İçe Aktarma",
    "feature_time_and_cost_tracking": "Zaman ve Maliyet Takibi",
    "feature_work_order_configuration": "İş Emri Yapılandırması",
    "feature_internal_requests": "Dahili Talepler",
    "feature_external_request_portal": "Harici Talep Portalı",
    "category_locations_assets_parts": "Konumlar, Varlıklar ve Parçalar",
    "feature_location_management": "Konum Yönetimi",
    "feature_barcode_scanning": "Barkod Tarama",
    "feature_inventory_management": "Envanter Yönetimi",
    "feature_custom_asset_statuses": "Özel Varlık Durumları",
    "feature_asset_downtime_tracking": "Varlık Arıza Süresi Takibi",
    "feature_asset_depreciation_tracking": "Varlık Amortisman Takibi",
    "feature_asset_warranty_tracking": "Varlık Garanti Takibi",
    "feature_purchase_orders_management": "Satın Alma Siparişleri",
    "feature_asset_check_in_out": "Varlık Giriş/Çıkış İşlemi",
    "category_mobile_offline": "Mobil Çevrimdışı",
    "feature_work_order_availability": "İş Emri Kullanılabilirliği",
    "feature_updating_status": "Durum Güncelleniyor",
    "feature_updating_tasks": "Güncelleme Görevleri",
    "feature_work_order_drafts": "İş Emri Taslakları",
    "feature_full_drill_down_reporting_history": "Detaylı Raporlama ve Geçmiş Verileri",
    "period_thirty_days": "30 Gün",
    "period_full": "Tam dolu",
    "feature_pdf_csv_exporting": "PDF ve CSV Dışa Aktarma",
    "feature_itemized_time_reporting": "Ayrıntılı Zaman Raporlaması",
    "feature_user_login_reports": "Kullanıcı Giriş Raporları",
    "feature_parts_consumption_reports": "Parça Tüketim Raporları",
    "feature_asset_downtime_reports": "Varlık Arıza Süreleri Raporları",
    "feature_equipment_reliability_reports": "Ekipman Güvenilirlik Raporları",
    "feature_multi_site_modules": "Çoklu lokasyonlu modüller",
    "category_integrations": "Entegrasyonlar",
    "feature_business_integrations": "İş Entegrasyonları (SAP/Oracle/Nedensel Yapay Zeka...)",
    ...
    "feature_articles": "Makaleler",
    "feature_training_webinars": "Eğitim Web Seminerleri",
    "feature_community_support_discord": "Topluluk Desteği (Discord)",
    "feature_email_support": "E-posta Desteği",
    "feature_chat_phone_support": "Sohbet/Telefon Desteği",
    "feature_priority_support": "Öncelikli Destek",
    "feature_implementation_training": "Uygulama ve Eğitim",
    "feature_dedicated_account_manager": "Özel Müşteri Temsilcisi",
    "category_customization": "Özelleştirme",
    "feature_custom_development": "Özel geliştirme",
    "sh_plan_basic_name": "Temel",
    "sh_plan_basic_description": "Kendi altyapıları üzerinde tam veri egemenliğine ve temel bakım takibine ihtiyaç duyan küçük ekipler için.",
    "sh_feature_core_work_order_management": "Temel İş Emri Yönetimi",
    "sh_feature_asset_inventory_tracking": "Varlık ve Stok Takibi",
    "sh_feature_local_data_storage": "Yerel Veri Depolama",
    "sh_plan_professional_name": "Profesyonel",
    "sh_plan_professional_description": "Gelişmiş kontrol listeleri, iş akışları ve daha derin sistem entegrasyonu gerektiren bitkilerin yetiştirilmesi için idealdir.",
    "sh_feature_everything_in_basic_plus": "Temel paketin tüm özelliklerine ek olarak:",
    "sh_feature_unlimited_assets_checklists": "Sınırsız Varlıklar/Kontrol Listeleri",
    "sh_feature_nfc_barcode_scanning": "NFC ve Barkod Tarama",
    "sh_feature_email_support": "E-posta Desteği",
    "sh_plan_business_name": "İşletme",
    "sh_plan_business_description": "Çoklu örnek yönetimi, özel marka kimliği ve üst düzey güvenlik gerektiren tam ölçekli operasyonlar.",
    "sh_feature_everything_in_professional_plus": "Professional Plus paketindeki her şey:",
    "sh_feature_multi_instance_management": "Çoklu Örnek Yönetimi",
    "sh_feature_custom_user_roles": "Özel Kullanıcı Rolleri",
    "sh_feature_priority_implementation_support": "Öncelikli Uygulama Desteği",
    "faq_free_users_q": "Hangi kullanıcı türleri ücretsiz kullanıcı olarak kabul edilir?",
    "faq_free_users_a1": "Ücretli lisans gerektirmeyen üç kullanıcı türü vardır:",
    "faq_view_only_users_title": "Yalnızca Kullanıcıları Görüntüle",
    "faq_view_only_users_description": "Bu kullanıcılar genellikle bakım faaliyetlerinin anlık görüntüsünü görmek için nadiren giriş yapan yöneticilerdir. Ayrıca iş talepleri gönderebilir ve raporlar çalıştırabilirler.",
    "faq_requester_users_title": "Talep Eden Kullanıcılar",
    "faq_requester_users_description": "Bu kullanıcılar yalnızca iş talepleri gönderebilir ve bu taleplerin durumunu görüntüleyebilirler. CMMS'de depolanan iş emirlerini, varlıkları, parçaları veya diğer verileri göremezler.",
    "faq_third_party_users_title": "Üçüncü Taraf Kullanıcılar",
    "faq_third_party_users_description": "Bu kullanıcılar genellikle tedarikçiler ve yüklenicilerdir. Sisteme fiilen giriş yapamazlar. Sadece herkese açık bir bağlantı aracılığıyla etiketlendikleri belirli bir iş emrine güncelleme gönderebilirler.",
    "faq_paid_users_q": "Hangi kullanıcı türleri ücretli kullanıcı olarak kabul edilir?",
    "faq_paid_users_a1": "Ücretli lisans gerektiren üç kullanıcı türü vardır:",
    "faq_admin_users_title": "Yönetici Kullanıcılar",
    "faq_admin_users_description": "Bu kullanıcılar hesaba başkalarını ekleme, iş taleplerini kabul etme veya reddetme ve iş emri ayrıntılarını düzenleme yeteneğine sahiptir. Hesabı kontrol eden kullanıcılar onlardır. Her hesap için birden fazla yönetici olabilir.",
    "faq_technical_users_title": "Teknik Kullanıcılar",
    "faq_technical_users_description": "Bu kullanıcılar genellikle sahada iş emirlerini kapatan teknisyenlerdir. Oluşturdukları iş emirlerini düzenleyebilirler ancak diğer iş emirlerini düzenleyemezler. İş emirlerine resim ve durum güncellemeleri ekleyebilir ve yeni iş emirleri oluşturabilirler.",
    "faq_limited_technical_users_title": "Sınırlı Teknik Kullanıcılar",
    "faq_limited_technical_users_description": "Bu kullanıcılar, teknik kullanıcıyla aynı ayrıcalıklara sahiptir. Tek istisna, yalnızca kendilerine atanmış iş emirlerini görebilmeleridir; hesaptaki diğer teknik kullanıcıların iş emirlerini göremezler.",
    "faq_change_plans_q": "Planlarımı daha sonra değiştirebilir miyim?",
    "faq_change_plans_a": "Evet, planınızı istediğiniz zaman yükseltebilir veya düşürebilirsiniz. Değişiklikler bir sonraki faturalama döneminizin başında yürürlüğe girer.",
    "faq_free_trial_q": "Ücretsiz deneme sürümü var mı?",
    "faq_free_trial_a": "Evet, karar vermeden önce tüm özellikleri deneyimleyebilmeniz için İşletme planının 15 günlük ücretsiz deneme sürümünü sunuyoruz.",
    "faq_non_profit_discounts_q": "Kâr amacı gütmeyen kuruluşlara indirim uyguluyor musunuz?",
    "faq_non_profit_discounts_a": "Evet, kar amacı gütmeyen kuruluşlar için özel fiyatlandırma sunuyoruz. Daha fazla bilgi için lütfen satış ekibimizle iletişime geçin.",
    "faq_payment_methods_q": "Hangi ödeme yöntemlerini kabul ediyorsunuz?",
    "faq_payment_methods_a": "Başlıca tüm kredi kartlarını, banka havalelerini ve PayPal'ı kabul ediyoruz. Kurumsal planlar için faturalama da düzenleyebiliriz.",
    "faq_cancel_subscription_q": "Aboneliğimi iptal edebilir miyim?",
    "faq_cancel_subscription_a": "Evet, aboneliğinizi istediğiniz zaman iptal edebilirsiniz. Mevcut faturalama döneminizin sonuna kadar erişiminiz devam edecektir.",
    "faq_data_secure_q": "Verilerim güvende mi?",
    "faq_data_secure_a": "Evet, veri güvenliğini çok ciddiye alıyoruz. Tüm veriler iletim sırasında ve depolanırken şifrelenir ve düzenli güvenlik denetimleri gerçekleştiriyoruz.",
