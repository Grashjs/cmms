const trJSON = {
  ...
  noRows: {
    ...
    customer: {
      message: "Müşteriler dışarıdan çalışanlardır",
      action: "Müşteri oluşturmak için '' butonuna basın",
    },
    vendor: {
      message: "Tedarikçiler Varlık veya Parça sağlayan kuruluşlardır",
  ...
  meters: "Ölçerler",
  people_teams: "Personeller & Ekipler",
  people: "Personeller",
  teams: "Ekipler",
  ...
  customers_description: "Müşterileri seçin",
  vendors_description: "Tedarikçi seçin",
  ...
  assigned_customers: "Atanan Müşteriler",
  assigned_vendors: "Atanan Tedarikçiler",
  no_access_location: "Konumlara erişiminiz yok. ",
  no_access_vendors_customers: "Tedarikçilere ve Müşterilere erişiminiz yok. ",
  ...
  customer_create_failure: "Müşteri oluşturulamadı",
  customer_edit_failure: "Müşteri düzenlenemedi",
  customer_delete_success: "Müşteri başarıyla silindi",
  customer_delete_failure: "Müşteri silinemedi",
  customer_name: "Müşteri adı",
  website: "İnternet sitesi",
  customer_type: "Müşteri türü",
  customer_type_description: "Ör. Sucu, Elektrikci ",
  customer_description_description: "Bu Müşterinin amacını birkaç satırla anlatın...",
  ...
  required_customer_name: "Müşteri Adı gerekli",
  required_phone: "Telefon numarası gerekli",
  invalid_website: "Geçersiz web sitesi",
  billing_address: "Fatura Adresi",
  add_customer: "Müşteri Ekle",
  add_customer_description: "Yeni bir Müşteri oluşturmak ve eklemek için aşağıdaki alanları doldurun",
  type: "Tip",
  billing_currency: "Faturalandırma Para Birimi",
  go_back: "Geri dön",
  confirm_delete_customer: "Bu Müşteriyi silmek istediğinizden emin misiniz?",
  vendor_create_success: "Tedarikçi başarıyla oluşturuldu",
  vendor_create_failure: "Tedarikçi oluşturulamadı",
  vendor_edit_failure: "Tedarikçi düzenlenemedi",
  vendor_delete_success: "Tedarikçi başarıyla silindi",
  vendor_delete_failure: "Tedarikçi silinemedi",
  required_company_name: "Şirket Adı gerekli",
  vendor_type: "Tedarikçi Türü",
  contact_name: "Kişi adı",
  add_vendor: "Tedarikçi ekle",
  add_vendor_description: "Yeni bir tedarikçi oluşturmak ve eklemek için aşağıdaki alanları doldurun",
  confirm_delete_vendor: "Bu tedarikçiyi silmek istediğinizden emin misiniz?",
  vendor_type_description: "Ör. Tesisatçı, Elektrikci ",
  role: "Rol",
  ...
  pricing_1: {
    ...
    faq_third_party_users_description:
      "Bu kullanıcılar genellikle tedarikçiler ve Müşterilerdir. Sisteme fiilen giriş yapamazlar. Sadece herkese açık bir bağlantı aracılığıyla etiketlendikleri belirli bir iş emrine güncelleme gönderebilirler.",
  ...
  free_cmms: {
    ...
    hero: {
      subtitle: "Ücretsiz CMMS Yazılımı",
      title: "İş Emirlerini ve Varlıkları Yönetin - Sonsuza Kadar Ücretsiz",
      description:
        "Elektronik tablolar ve güncelliğini yitirmiş araçlarla uğraşmayı bırakın. Modern bir CMMS yazılımına ücretsiz geçin.",
      start_free: "Şimdi Ücretsiz Başlayın",
      work_orders_alt: "İş Emirleri",
      mobile_app_alt: "Mobil Uygulama",
    },
    features: {
      work_orders: {
        title: "Zahmetsiz İş Emirleri",
        p1: "Saniyeler içinde iş emirleri oluşturun, atayın ve takip edin.",
        p2: "Herhangi bir göreve fotoğraf, kılavuz ve kontrol listesi ekleyin.",
        p3: "Anlık durum güncellemeleriyle ilerlemeyi gerçek zamanlı olarak izleyin.",
        alt: "İş Emri Yönetimi",
      },
      asset_tracking: {
        title: "Varlık Yaşam Döngüsü Takibi",
        p1: "Her varlığın eksiksiz bir dijital geçmişini tutun.",
        p2: "Onarım veya değiştirme konusunda veriye dayalı kararlar verin.",
        p3: "Otomatik uyumluluk günlükleriyle denetime hazır kalın.",
        alt: "Varlık Yönetimi",
      },
      inventory: {
        title: "Envanter ve Parçalar",
        p1: "Birden fazla konumdaki stok seviyelerini gerçek zamanlı olarak takip edin.",
        p2: "Anında parça sorgulama ve kullanım için QR kodlarını tarayın.",
        p3: "Otomatik düşük stok uyarıları alın ve anında yeniden sipariş verin.",
        alt: "Envanter Yönetimi",
      },
      mobile: {
        title: "Hareket Halinde Bakım",
        p1: "iOS ve Android için tam mobil uygulama işlevselliği.",
        p2: "Doğrudan sahadan fotoğraf çekin ve barkodları tarayın.",
        p3: "Verileri anında senkronize edin ve gerektiğinde çevrimdışı çalışın.",
        alt: "Mobil CMMS Uygulaması",
      },
      get_started_free: "Ücretsiz başlayın",
      ready_to_optimize: "Bakımınızı optimize etmeye hazır mısınız?",
      join_thousands: "Dünyanın en sezgisel ücretsiz CMMS'sini kullanan binlerce bakım uzmanına katılın.",
      get_started_no_card: "Ücretsiz başlayın - Kredi kartı gerekmez",
    },
  },
  overview_1: {
    description:
