const ptBRJSON = {
  ...
  free_cmms: {
    ...
    hero: {
      subtitle: "Software CMMS Grátis",
      title: "Gerencie Ordens de Serviço e Ativos - Grátis para Sempre",
      description:
        "Pare de fazer malabarismos com planilhas e ferramentas desatualizadas. Atualize para um software CMMS moderno - de graça.",
      start_free: "Comece Grátis Agora",
      work_orders_alt: "Ordens de Serviço",
      mobile_app_alt: "Aplicativo Móvel",
    },
    features: {
      work_orders: {
        title: "Ordens de Serviço Sem Esforço",
        p1: "Crie, atribua e rastreie ordens de serviço em segundos.",
        p2: "Anexe fotos, manuais e listas de verificação a qualquer tarefa.",
        p3: "Monitore o progresso em tempo real com atualizações de status instantâneas.",
        alt: "Gestão de Ordens de Serviço",
      },
      asset_tracking: {
        title: "Rastreamento do Ciclo de Vida dos Ativos",
        p1: "Mantenha um histórico digital completo de cada ativo.",
        p2: "Tome decisões baseadas em dados sobre reparo vs. substituição.",
        p3: "Esteja pronto para auditorias com registros de conformidade automatizados.",
        alt: "Gestão de Ativos",
      },
      inventory: {
        title: "Estoque e Peças",
        p1: "Rastreie níveis de estoque em vários locais em tempo real.",
        p2: "Escaneie códigos QR para busca e uso instantâneo de peças.",
        p3: "Receba alertas automáticos de estoque baixo e reabasteça instantaneamente.",
        alt: "Gestão de Estoque",
      },
      mobile: {
        title: "Manutenção em Movimento",
        p1: "Funcionalidade completa do aplicativo móvel para iOS e Android.",
        p2: "Capture fotos e escaneie códigos de barras diretamente do campo.",
        p3: "Sincronize dados instantaneamente e trabalhe offline quando necessário.",
        alt: "Aplicativo CMMS Móvel",
      },
      get_started_free: "Comece de graça",
      ready_to_optimize: "Pronto para otimizar sua manutenção?",
      join_thousands:
        "Junte-se a milhares de profissionais de manutenção que usam o CMMS gratuito mais intuitivo do mundo.",
      get_started_no_card: "Comece de graça - Sem necessidade de cartão de crédito",
    },
  },
  overview_1: {
    description:
